...
export default function PlantEditForm({ plant, user, onSuccess }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success("แก้ไขข้อมูลพืชสำเร็จ");
      onSuccess?.();
    } catch (error) {
  ...
  return (
    <Card className="border-0 shadow-lg rounded-2xl">
      <CardHeader className="border-b bg-gray-50/50 rounded-t-2xl">
        <CardTitle className="text-xl text-gray-800">แก้ไขข้อมูลพืช</CardTitle>
      </CardHeader>
